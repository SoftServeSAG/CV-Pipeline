...
from model_training.common.models.semantic_segmentation.mobilenet_v2 import MobileNetV2
...
class FPNMobileNet(nn.Module):
    def __init__(
        self, num_classes=3, num_filters=128, num_filters_fpn=128, pretrained=True
    ):
        super().__init__()
